...
try:
    ...
    import controlled_ODE_RNN.train as train
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--dataset', type=str, help="one of: 'BlackScholes', 'Heston', 'OrnsteinUhlenbeck'",
    ...
    train.train(
        model_id=model_id, epochs=epochs, batch_size=200, save_every=save_every,
